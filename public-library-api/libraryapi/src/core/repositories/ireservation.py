...
from src.core.domain.reservation import Reservation, ReservationIn, ReservationStatus
...
class IReservationRepository(ABC):
    ...
    @abstractmethod
    async def update_reservation_status(self, reservation_id: UUID4, status: ReservationStatus) -> bool:
